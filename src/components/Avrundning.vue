<template>
    ...
    <div class="litestorre">Avrunda till närmaste<br><b>{{tal1}}</b>-tal</div>
    <div class="fragan">
...
export default {
    ...
    data: function () {
        return {
            tal1: Math.pow(10, Math.floor(Math.random() * 3) +1 ),
            tal2: Math.floor(Math.random() * 10000),
    ...
    methods: {
        kollaSvar: function() {
            var that;
            if (this.$refs.svaret.value == Math.round(this.tal2/this.tal1)*this.tal1) {
                ...
                setTimeout(function(){
                    ...
                    that.tal1 = Math.pow(10, Math.floor(Math.random() * 3) +1 );
                    that.tal2 = Math.floor(Math.random() * 10000);
                }, 2010);
            } else {
